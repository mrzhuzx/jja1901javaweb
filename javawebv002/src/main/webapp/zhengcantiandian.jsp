...
<base href="<%=basePath%>">
<!DOCTYPE html>
<!-- saved from url=(0067)zhengcantiandian.jsp -->
                            ...
                            <ul class="primary-menu">
                                ...
                                <li class="primary-menu-item selected"><a class="primary-menu-item-target" href="zhengcancuxiao.jsp"><span>正餐菜单</span><i class="fa fa-angle-right"></i></a>
                                    <ul class="secondary-menu">
                                        ...
                                        <li class="secondary-menu-item selected"><a class="secondary-menu-item-target" href="zhengcantiandian.jsp"><i class="fa fa-circle"></i> <span>甜品</span></a></li>
                                ...
                                <div id="product-cards" data-equal-height=".col-xs-6 .product-title">
                                    <div class="row row-narrow">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/5088.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">苹果派</h5>
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4106.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">香芋派</h5>
                                                    <div class="product-badges">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4105.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">菠萝派</h5>
                                                    <div class="product-badges">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1217.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">麦旋风奥利奥原味</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥11.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4900.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">麦旋风草莓口味</h5>
                                                    <div class="product-badges">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4410.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">巧克力新地</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥8.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4416.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">草莓新地</h5>
                                                    <div class="product-badges">
