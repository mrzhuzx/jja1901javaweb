        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
            ...
            <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                ...
                <ul class="am-dropdown-content">
                    ...
                    <li><a href="ai?todo=adminLoginOut"><span class="am-icon-power-off"></span> 退出</a></li>
                </ul>
            </li>
...
<form action="food?todo=searchByPage" method="post" name="form1">
                ...
                <div class="am-g">
                    ...
                    <div class="am-u-sm-12 am-u-md-3">
                        <div class="am-form-group">
                            ...
                            <select data-am-selected="{btnSize: 'sm'}" name="foodStyleId">

                                <option value="0" >所有类别</option>
                                <c:forEach  var="fsl" items="${requestScope.foodStyleList}">
                                 <option value="${fsl.foodStyleId}" <c:if test="${fsl.foodStyleId  eq requestScope.foodStyleId}">selected="selected" </c:if>>${fsl.foodStyleName}</option>
                    ...
                    <div class="tpl-table-images">
                        ...
                        <div class="am-u-sm-12 am-u-md-6 am-u-lg-4">
                            ...
                            <div class="tpl-table-images-content">
                                <div class="tpl-table-images-content-i-time">产品数量：${f.foodCount}</div>
                                <div class="tpl-i-title">${f.foodName}(${f.foodId})--${f.imagesPath}</div>
                            ...
                            <div class="am-cf">
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        <li><a href="food?todo=searchByPage&pageNum=${pageNum-1}">«</a></li>
                                        <c:forEach begin="${pageNum}" end="${pageNumAll}" var="num">
                                        <li class="am-active"><a href="food?todo=searchByPage&pageNum=${num}">${num}</a></li>
                                        </c:forEach>
                                        <li><a href="food?todo=searchByPage&pageNum=${pageNum+1}">»</a></li>
                                    </ul>
                                </div>
