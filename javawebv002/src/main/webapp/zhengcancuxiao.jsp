                    ...
                    <div class="sidebar-menu" data-sticky="true">
                        <div class="food-menu">
                            <ul class="primary-menu">
                                ...
                                <li class="primary-menu-item selected"><a class="primary-menu-item-target" href="caidanyinpin.jsp"><span>正餐菜单</span><i class="fa fa-angle-right"></i></a>
                                    <ul class="secondary-menu">
                                        <li class="secondary-menu-item selected"><a class="secondary-menu-item-target" href="zhengcancuxiao.jsp"><i class="fa fa-circle"></i> <span>促销产品和热卖产品</span></a></li>
                                        ...
                                        <li class="secondary-menu-item "><a class="secondary-menu-item-target" href="caidanyinpin.jsp"><i class="fa fa-circle"></i> <span>饮品</span></a></li>
                                ...
                                <li class="primary-menu-item"><a class="primary-menu-item-target" href="caidanyinpin.jsp"><span>早餐菜单</span><i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="clearfix">
                        <div class="page-breadcrumbs pull-left">
                            <ol class="breadcrumb type-sans">
                                <li><a href="caidanyinpin.jsp">浏览菜单</a></li>

                                <li class="active">促销产品和热卖产品</li>
                                ...
                                <div id="product-cards" data-equal-height=".col-xs-6 .product-title">
                                    <div class="row row-narrow">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/8350.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">麦趣鸡盒升级岩烧风味鸡翅</h5>
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥72.00</span>
                                                                </div>
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1121.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">麦趣鸡盒</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥69.00</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/8615.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">豪情派对聚享餐</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥98.00</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/8616.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">麦乐家庭餐</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥81.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/7097.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">阿狸钥匙包1个（款式随机）</h5>
                                                    <div class="product-badges">
                                                        <span class="food-icons-sprite food-icons-new ir"></span>
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥18.00</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                    ...
                    <div class="column">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="menu-item">
                                ...
                                <a class="menu-item-target footer-icon wb" href="#">新浪微博</a>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-offset-3 col-xs-6">
                        <form action="index.jsp" method="post" accept-charset="utf-8" role="form" id="form_login_modal" name="form_login_modal" class="form-login-modal form-login" data-required-symbol="false" novalidate>
...
<div id="trackOrder" class="modal-trackorder modal fade" data-backdrop="static" role="dialog" aria-labelledby="trackorder-title" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>请输入订单号码，查询订单状态。</p>
                <form action="chucuochuli.jsp" method="post" role="form" id="form_trackOrder" name="form_trackOrder" class="form form-track-order" novalidate>
