...
<div class="am-g myapp-login">
    <div class="myapp-login-logo-block  tpl-login-max">
        ...
        <div class="am-u-sm-10 login-am-center">
            <form class="am-form" method="post" action="ai?todo=adminlogin">
                <fieldset>
                    <div class="am-form-group">
                        <input type="email" class="" name="adminEmail" value="admin@qq.com" id="doc-ipt-email-1" placeholder="输入电子邮件">
                    </div>
                    <div class="am-form-group">
