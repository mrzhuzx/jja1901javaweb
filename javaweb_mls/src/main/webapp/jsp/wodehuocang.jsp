...
<base href="<%=basePath%>">
<!DOCTYPE html>
<!-- saved from url=(0054)https://www.4008-517-517.cn/cn/account-favourites.jsp -->
            ...
            <div class="row row-narrow">
                <div class="page-sidebar">
                    <div class="sidebar-menu">
                        ...
                        <ul class="menu">
                            <li class="menu-item"><a class="menu-item-target" href="zhuizongdingdan.jsp">追踪订单</a></li>
                            <li class="menu-item"><a class="menu-item-target" href="dingcanjilu.jsp">订餐记录</a></li>
                            <li class="menu-item selected"><a class="menu-item-target" href="wodeshoucang.jsp">我的收藏</a></li>
                    ...
                    <div class="row row-narrow">
                        <div class="col-xs-8">
                            <div class="page-content">
                                <div class="panel-lg panel panel-default panel">
                                    <div class="panel-body">
                                        <h3>目前我的收藏中没有订单。</h3>
                                        <div class="empty-template">点击“浏览菜单”立即订餐，订单提交成功后可以保存到我的收藏。</div>
                                    </div>
                                </div>
                            ...
                            <div id="order-widget" class="panel panel-basic panel-narrow order-summary">
                                ...
                                <div class="panel-section-group">
                                    <section class="panel-section section-delivery-address">
                                        <table class="table-default table-delivery-address">
                                            ...
                                            <tr>
                                                <th scope="row">送餐至:
                                                    <div>
                                                        <a href="address.jsp" data-target="#alertCartCleared" data-toggle="modal" class="action-link action-edit action-edit-address">编辑</a>
                                    ...
                                    <section class="panel-section section-delivery-datetime">
                                        <table class="table-default table-delivery-datetime">
                                            ...
                                            <tr>
                                                <th scope="row">送餐时间:
                                                    <div>
                                                        <a href="#" data-target="#alertCartCleared" data-toggle="modal" class="action-link action-edit action-edit-datetime">编辑</a>

                                                    </div>
                                                </th>
                                                <td>
                                                    <div class="when-to-deliver"></div>
                                                    <div class="how-long-to-deliver"><b>预计送餐时间:</b><span>14/12/24 11:02 (30 分钟)</span></div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <section class="panel-section section-promocode">
                                        <a href="#" class="action-link action-edit action-edit-promocode collapsed" data-toggle="collapse">有优惠代码？</a>
                                        <div id="enter-promocode" class="collapse">
                                            <form class="form-promocode" role="form" id="form_promocode" name="form_promocode" method="post" action="https://www.4008-517-517.cn/cn/applyCoupon.jsp">

                                                <div class="form-group ">
                                                    <div class="input-group">
                                                        <input type="text" name="couponCode" id="couponCode" class="form-control">
                                                        <div class="input-group-btn">
                                                            <button type="submit" class="btn btn-red">使用</button>
                                                        </div>
                                                    </div>
                                    ...
                                    <section class="panel-section section-cost-breakdown">
                                        ...
                                        <fieldset class="form-actions text-center">
                                            <div class="form-group">
                                                ...
                                                <a class="btn btn-red btn-block btn-xl" href="#">立即结账</a>
                                                ...
                                                <div>
                                                    <div>
                                                        <div class="item-heading clearfix">
                                                            ...
                                                            <div class="picture"><img alt="" class="img-block" src="../img/1121.png"></div>
                                                            <div class="details">
                                                                <h5 class="product-name">麦趣鸡盒含：香骨鸡腿（3个）+麦辣鸡翅（6块）+麦乐鸡（7块）</h5>
                                                                <ul>
                                                                    <li>麦趣鸡盒</li>
                                                                    <li>可口可乐（中）</li>
                                                                    <li>可口可乐（中）</li>
                                                        ...
                                                        <div class="item-body clearfix">
                                                            <div class="controls">
                                                                <a class="action-edit action-edit-order" data-orderid="88" href="#" title="编辑"><i class="mcd mcd-edit icon"></i></a>
                                                                <a class="action-delete action-delete-order" data-orderid="88" href="#" title="删除"><i class="mcd mcd-remove icon"></i></a>
                                                            </div>

                                                            <div class="cost">¥69.00</div>
                                                        </div>
                                                    </div>
                ...
                <div class="description">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="product-nutritional-info show-on-expand">
                            <a href="#" class="action-link" data-toggle="html-popover" data-placement="bottom" data-html="true" data-content-selector=".popover-details"><i class="mcd icon mcd-detail"></i> <span class="text-default">{{additionInfo.inLineInfo}}</span></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-4 pull-left">
                    <a href="#" class="h5 text-default text-ucase btn-back action-cancel"><i class="fa fa-caret-left text-primary"></i> 返回至&ldquo;我的收藏&rdquo;</a>
                </div>
...
<script type="text/template" id="condiments-configurator-template">
    <div class="configurator-header">
        <div class="container">
            <div class="row">
                ...
                <div class="picture show-on-expand text-center"><img src="http://placehold.it/240x180/" alt="" /></div>
                <div class="description">
    ...
    <div class="configurator-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-4 pull-left">
                    <a href="#" class="h5 text-default text-ucase btn-back action-cancel"><i class="fa fa-caret-left text-primary"></i> 回到菜单</a>
                </div>
                <div class="col-xs-4 pull-right text-center">
                    <button class="btn btn-primary btn-red btn-lg btn-block btn-submit btn-saveorder action-saveorder"><i class="mcd icon mcd-bag"></i>
                        {{#if isNewOrder}}
...
<script type="text/template" id="productset-template">
    ...
    <td class="calories-column">{{additionInfo.inLineInfo}}</td>
</script>
    ...
    <form action="" accept-charset="utf-8">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><span class="instruction">请选择{{quantity}}个项目。</span></p>
                ...
                <div class="modal-footer text-center">
                    <button type="button" class="btn btn-red btn-lg btn-submit" data-dismiss="modal">完成</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </form>
...
<div id="removeMyFav" data-backdrop="static" class="modal-removemyfav modal-alert modal fade" role="dialog" aria-labelledby="removemyfav-title" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 id="removemyfav-title">从我的收藏中删除</h1>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa mcd mcd-close"></i></button>
            </div>
            <div class="modal-body">
                <div class="alert-content">
                    <p><span>确认要删除这笔订单？</span></p>
                    <form class="form" role="form" id="form_removeFav" method="post" action="https://www.4008-517-517.cn/cn/delete/account-favourites.jsp">

                        <div class="form-group">
                            <input type="hidden" name="id" value="">
                        </div>
                        <div class="form-group">
                            <button data-dismiss="modal" aria-hidden="true" class="btn btn-default btn-black btn-lg text-ucase"><span>取消</span></button>
                            <button type="submit" aria-hidden="true" class="btn btn-default btn-red btn-lg text-ucase"><span>确认</span></button>
                        </div>
                        <input type="hidden" name="csrfValue" value="998F500"></form>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert-content">
                    <p>是否继续？</p>
                    <p>
                        <button data-switch-modal="#deliveryOptions" data-toggle="modal" aria-hidden="true" class="btn btn-default btn-red btn-lg text-ucase">是</button>
                        <button data-dismiss="modal" aria-hidden="true" class="btn btn-default btn-red btn-lg text-ucase">否</button>
                    </p>
                </div>
            </div>
        </div>
    ...
    var _WOS = {
        Store: {
            config: {
                ...
                api: {
                    availableMeals: {
                        findAll: '/cn/configurator/favProducts.json'
                    },
                    availableChoices: {
                    ...
                    cart: {
                        edit: '/cn/configurator/favCart.json',
                        save: '/cn/configurator/favCart.json'
                    }
                }
            }
        }
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        $('#my-favourite').on('click', '.remove-fav', function(event){
            event.preventDefault();
            var favid = $(this).attr('favId');

            $('#removeMyFav').one('shown.bs.modal', function(){
                var hiddenInput = $('[name="id"]');
                hiddenInput.val(favid);
            }).modal('show');
        });
...
<div class="ui-selectmenu-menu hide-default-error" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliveryoptions_address-button" id="form_deliveryoptions_address-menu" style="width: 100px;" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-169"><li role="presentation" class="ui-corner-bottom ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-169">厦门市 思明区 湖滨中路557号  国贸春天 1号楼 2层 2室</a></li></ul></div><div class="ui-selectmenu-menu hide-default-error" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliveryoptions_date-button" id="form_deliveryoptions_date-menu" style="width: 100px; height: 244px;" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-605"><li role="presentation" class="ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-605">2014/12/24</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/25</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/26</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/27</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/28</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/29</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/30</a></li><li role="presentation" class="ui-corner-bottom"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">2014/12/31</a></li></ul></div><div class="ui-selectmenu-menu hide-default-error" style="z-index: 1042; top: 0px; left: 0px;"><ul class="ui-widget ui-widget-content ui-selectmenu-menu-dropdown ui-corner-bottom" aria-hidden="true" role="listbox" aria-labelledby="form_deliveryoptions_time-button" id="form_deliveryoptions_time-menu" style="width: 100px; height: 244px;" aria-disabled="false" tabindex="0" aria-activedescendant="ui-selectmenu-item-430"><li role="presentation" class="ui-selectmenu-item-selected ui-selectmenu-item-focus"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="true" id="ui-selectmenu-item-430">请选择送餐时间</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">11:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">12:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">12:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">12:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">12:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">13:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">13:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">13:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">13:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">14:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">14:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">14:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">14:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">15:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">15:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">15:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">15:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">16:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">16:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">16:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">16:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">17:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">17:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">17:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">17:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">18:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">18:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">18:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">18:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">19:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">19:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">19:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">19:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">20:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">20:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">20:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">20:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">21:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">21:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">21:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">21:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">22:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">22:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">22:30</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">22:45</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">23:00</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">23:15</a></li><li role="presentation"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">23:30</a></li><li role="presentation" class="ui-corner-bottom"><a href="https://www.4008-517-517.cn/cn/account-favourites.jsp#nogo" tabindex="-1" role="option" aria-selected="false">23:45</a></li></ul></div></body></html>