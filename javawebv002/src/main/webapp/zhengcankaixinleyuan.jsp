...
<base href="<%=basePath%>">
<!DOCTYPE html>
<!-- saved from url=(0067)zhengcankaixinleyuan.jsp -->
                            ...
                            <ul class="primary-menu">
                                ...
                                <li class="primary-menu-item selected"><a class="primary-menu-item-target" href="zhengcancuxiao.jsp"><span>正餐菜单</span><i class="fa fa-angle-right"></i></a>
                                    <ul class="secondary-menu">
                                        ...
                                        <li class="secondary-menu-item selected"><a class="secondary-menu-item-target" href="zhengcankaixinleyuan.jsp"><i class="fa fa-circle"></i> <span>开心乐园餐</span></a></li>
                                ...
                                <div id="product-cards" data-equal-height=".col-xs-6 .product-title">
                                    <div class="row row-narrow">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/3469.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">开心乐园餐（汉堡包）</h5>
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥19.00</span>
                                                                </div>
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/3470.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">开心乐园餐（吉士汉堡包）</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥21.00</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/3471.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 38px;">开心乐园餐（麦乐鸡）</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥18.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
