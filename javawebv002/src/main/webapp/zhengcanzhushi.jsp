                            ...
                            <ul class="primary-menu">
                                ...
                                <li class="primary-menu-item selected"><a class="primary-menu-item-target" href="zhengcancuxiao.jsp"><span>正餐菜单</span><i class="fa fa-angle-right"></i></a>
                                    <ul class="secondary-menu">
                                        ...
                                        <li class="secondary-menu-item selected"><a class="secondary-menu-item-target" href="zhengcanzhushi.jsp"><i class="fa fa-circle"></i> <span>主食和超值套餐</span></a></li>
                                        ...
                                        <li class="secondary-menu-item "><a class="secondary-menu-item-target" href="caidanyinpin.jsp"></i> <span>饮品</span></a></li>
                                ...
                                <li class="primary-menu-item"><a class="primary-menu-item-target" href="zhengcancuxiao.jsp"><span>早餐菜单</span><i class="fa fa-angle-right"></i></a>
                    ...
                    <div class="clearfix">
                        <div class="page-breadcrumbs pull-left">
                            <ol class="breadcrumb type-sans">
                                <li><a href="zhengcancuxiao.jsp">浏览菜单</a></li>

                                <li class="active">主食和超值套餐</li>
                                ...
                                <div id="product-cards" data-equal-height=".col-xs-6 .product-title">
                                    <div class="row row-narrow">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4648.png" class="img-block" alt="">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥20.50</span>
                                                                </div>
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1440.png" class="img-block" alt="">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥15.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1406.png" class="img-block" alt="">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥17.00</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1100.png" class="img-block" alt="">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥17.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1106.png" class="img-block" alt="">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥19.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1120.png" class="img-block" alt="">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥16.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1600.png" class="img-block" alt="">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1450.png" class="img-block" alt="">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥9.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1010.png" class="img-block" alt="">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1000.png" class="img-block" alt="">
