...
<base href="<%=basePath%>">
<!DOCTYPE html>
<!-- saved from url=(0067)zhengcanxiaoshi.jsp -->
                            ...
                            <ul class="primary-menu">
                                ...
                                <li class="primary-menu-item selected"><a class="primary-menu-item-target" href="zhengcancuxiao.jsp"><span>正餐菜单</span><i class="fa fa-angle-right"></i></a>
                                    <ul class="secondary-menu">
                                        ...
                                        <li class="secondary-menu-item selected"><a class="secondary-menu-item-target" href="zhengcanxiaoshi.jsp"><i class="fa fa-circle"></i> <span>小食</span></a></li>
                                ...
                                <div id="product-cards" data-equal-height=".col-xs-6 .product-title">
                                    <div class="row row-narrow">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/8346.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">岩烧风味鸡翅</h5>
                                                        ...
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥10.00</span>
                                                                </div>
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1119.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">香骨鸡腿</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥12.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1700.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">麦辣鸡翅</h5>
                                                    <div class="product-badges">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/1401.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">麦乐鸡</h5>
                                                    <div class="product-badges">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4800.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">薯条</h5>
                                                    <div class="product-badges">
                                                ...
                                                <div class="panel-footer">
                                                    <div class="row row-narrow">
                                                        <div class="col-xs-6">
                                                            <div class="product-details">
                                                                <div class="product-cost">
                                                                    <span class="starting-price">¥7.50</span>
                                                                </div>
                                                                <div class="product-nutritional-info">
                                        ...
                                        <div class="col-lg-4 col-xs-6">
                                            <div class="panel panel-default panel-product">
                                                <div class="panel-body">
                                                    <img src="img/4437.png" class="img-block" alt="">
                                                    <h5 class="product-title" style="height: 19px;">玉米杯</h5>
                                                    <div class="product-badges">
