    ...
    <div class="wrap container">
        ...
        <div class="main">
            <div class="row row-narrow">
                <jsp:include page="caidanyinpin-left.jsp"/>
                        ...
                        <div class="row row-narrow">
                            <div class="col-xs-8">
                                <div id="product-cards" data-equal-height=".col-xs-6 .product-title">
                                    <div class="row row-narrow">
                                        <c:forEach items="${page.records }" var="food">
                                            <div class="col-lg-4 col-xs-6">
                                                <div class="panel panel-default panel-product">
                                                    <div class="panel-body">
                                                        <img src="${food.imagespath}" class="img-block" alt="">
                                                        <h5 class="product-title"
                                                            style="height: 19px;">${food.foodname}</h5>
                                                            ...
                                                            <div class="col-xs-6">
                                                                <div class="product-details">
                                                                    <div class="product-cost">
                                                                        <span class="starting-price">¥${food.foodprice}</span>
                                                                    </div>
                                ...
                                <div class="panel panel-basic panel-narrow">
                                    <div class="panel-section-group">
                                        <section class="panel-section how-it-works">
                                            <a href="mlslogin.jsp" data-toggle="modal" data-target="#signin"><img
                                                    src="../img/how_mcdelivery_works_portrait_zh.png"></a>
                                        </section>
                                    </div>
                                </div>
                            </div>
