...
<base href="<%=basePath%>">
<!DOCTYPE html>
<!-- saved from url=(0051)wangjimima.jsp -->
            ...
            <div class="page-content">
                <div class="panel panel-lg panel-default order-verification type-sans">
                    ...
                    <div class="panel-body">
                        <form action="wangjimima.jsp" method="post" role="form" id="form_forgotpassword" name="form_forgotpassword" novalidate>
                            <div class="row">
                                <div class="col-xs-4">
                                    <div class="form-group">


                                        <label for="verification-code" class="field-label">用户名:</label>

                                        <input type="text" name="userName" id="form_forgotpassword_verification" class="form-control input-lg required email" placeholder="name@mail.com" value="" aria-required="true">
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-red btn-lg">提交</button>
                            <input type="hidden" name="csrfValue" value="61093FA"></form>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function() {
        ...
        $.ajaxPrefilter(function(options, originalOptions, jqXHR) {
            var sId = 'A03C412370F7FAB80506D328761093FA.s21t10';
