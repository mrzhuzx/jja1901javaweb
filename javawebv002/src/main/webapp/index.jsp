...
<head>
    ...
    _gaq.push(['_setAccount', 'UA-24138769-1']);
                ...
                <div class="main-navigation clearfix">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item menu-item-account dropdown">
                            <a class="menu-item-target dropdown-toggle" href="zhanghushezhi.jsp" data-toggle="modal"
                               data-target="#signin">
        ...
        <div class="main" role="main">
            ...
            <section class="home-masthead page-masthead home-section">
                <div class="slideshow" style="position: relative; height: 475px;">
                    ...
                    <div class="cycle-pager slide-pager"><a href="mlslogin.jsp"
                                                            class="slide-pager-target ir cycle-pager-active">1</a></div>


                    <a class="slide-target slide-item action-ordernow cycle-slide cycle-slide-active"
                       style="background-image: url(img/landing_3255_getImage_br_cn.jpg); position: absolute; top: 0px; left: 0px; opacity: 1; z-index: 99;">
                    </a></div>
                ...
                <div class="panel panel-home-masthead panel-home-masthead-login">
                    ...
                    <div class="panel-body">
                        <form action="#" method="post" accept-charset="utf-8" role="form" id="form_login_masthead"
                              name="form_login_masthead" class="panel-home-masthead-form" data-required-symbol="false"
                              novalidate>
                            <fieldset class="form-credentials">
                                <div class="list-group textfield-list-group">
                                    <div class="list-group-item textfield-list-group-item">
                                        ...
                                        <input type="text" name="userName" id="form_login_masthead_username"
                                               class="required email list-group-form-control" placeholder="邮箱"
                                               autocomplete="off" value="" aria-required="true">
                                    </div>
                                    <div class="list-group-item textfield-list-group-item">
                                        <label class="sr-only" for="form_login_masthead_password">Password</label>
                                        <input type="password" name="password" id="form_login_masthead_password"
                                               class="required list-group-form-control" placeholder="密码"
                                               autocomplete="off" value="" aria-required="true">
                                    </div>
                                </div>
                                ...
                                <div class="checkbox">
                                    <div class="icheckbox" style="position: relative;"><input type="checkbox"
                                        ...
                                        <ins class="iCheck-helper"
                                             style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background-color: rgb(255, 255, 255); border: 0px; opacity: 0; background-position: initial initial; background-repeat: initial initial;"></ins>
                                    </div>
                            ...
                            <fieldset class="form-actions">
                                <button type="submit" class="btn btn-default btn-red btn-block btn-xl btn-submit">登录
                                </button>
                                <p class="action-forgot-password "><a class="action-link"
                                                                      href="wangjimima.jsp">忘记密码？</a></p>
            ...
            <section class="promotions home-section">
                <div class="row">
                    <div class="col-xs-4 text-center promotion">
                        ...
                        <p><a data-toggle="modal" href="30fen.jsp" target="_blank"><img
                                class="img-block promotion-thumbnail" alt=""
                                src="img/home_promo_3267_home_promo_2734_MDS-banner_cn_1.jpg"></a></p>
                    ...
                    <div class="col-xs-4 text-center promotion">
                        ...
                        <p><a data-toggle="modal" href="App.jsp" target="_blank"><img
                                class="img-block promotion-thumbnail" alt=""
                                src="img/home_promo_3268_home_promo_2735_MDS-banner_cn_2.jpg"></a></p>
                    ...
                    <div class="col-xs-4 text-center promotion">
                        ...
                        <p><a data-toggle="modal" href="dicanxuzhi.jsp" target="_blank"><img
                                class="img-block promotion-thumbnail" alt=""
                                src="img/home_promo_3269_home_promo_2736_MDS-banner_cn_3.jpg"></a></p>
...
<div id="signin" class="modal-login modal fade" role="dialog" aria-labelledby="modal-title" aria-hidden="true"
     tabindex="-1">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-offset-3 col-xs-6">
                        <form action="https://www.4008-517-517.cn/cn/login.jsp" method="post" accept-charset="utf-8"
                              role="form" id="form_login_modal" name="form_login_modal"
                              class="form-login-modal form-login" data-required-symbol="false" novalidate>
                            <fieldset class="form-credentials">
                                <div class="list-group textfield-list-group">
                                    <div class="list-group-item textfield-list-group-item">
                                        <label class="sr-only" for="form_login_modal_username">邮箱</label>
                                        <input type="text" name="userName" id="form_login_modal_username"
                                               class="required email list-group-form-control" placeholder="邮箱"
                                               autocomplete="off" value="" aria-required="true">
                                    </div>
                                    <div class="list-group-item textfield-list-group-item">
                                        <label class="sr-only" for="form_login_modal_password">密码</label>
                                        <input type="password" name="password" id="form_login_modal_password"
                                               class="required list-group-form-control" placeholder="密码"
                                               autocomplete="off" value="" aria-required="true">
                                    </div>
                                </div>
...
<div id="trackOrder" class="modal-trackorder modal fade" data-backdrop="static" role="dialog"
            ...
            <div class="modal-body">
                ...
                <form action="https://www.4008-517-517.cn/cn/searchOrder.jsp" method="post" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-lg required" id="form_trackOrder_orderNum"
                               name="orderNum" aria-required="true">
                    </div>
                    <div class="form-group">
...
<div id="alertTimeOut" data-backdrop="static" class="modal-timeout modal-alert modal fade" role="dialog"
     aria-labelledby="timeout-title" aria-hidden="true" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="alert-content">
                    ...
                    <p>
                        <button data-dismiss="modal" aria-hidden="true"
                                class="btn btn-default btn-red btn-lg text-ucase">是的
                        </button>
                    </p>
                </div>
            </div>
...
<div id="rememberMe" class="modal-rememberme modal fade" data-backdrop="static" role="dialog"
